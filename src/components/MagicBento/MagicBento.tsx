...
const DEFAULT_GLOW_COLOR = '179, 125, 34'; // Gold glow color
...
const cardData: CardItem[] = [
  ...
  },
  {
    ...
    description: 'Image recognition, object detection, and video analysis systems for industrial applications.',
    label: 'CV · DETECTION'
  },
  {
    color: '#ffffff',
    ...
    <>
      ...
      <BentoCardGrid gridRef={gridRef}>
        {cardData.map((card, index) => {
          ...
          // CSS variables defined as React.CSSProperties
          const cardStyle = {
